...
def get_settings_from_env(controller_port=None,
    ...
    settings["visualization_server_image"] = \
        ...
        os.environ.get("VISUALIZATION_SERVER_IMAGE", "quay.io/ibm/kubeflow-visualization-server-ppc64le")

    settings["frontend_image"] = \
        frontend_image or \
        os.environ.get("FRONTEND_IMAGE", "quay.io/ibm/kubeflow-frontend-ppc64le")
